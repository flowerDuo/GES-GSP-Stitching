...
/// <returns></returns>
vector<vector<Point>> connectCollineationLine(vector<vector<Point>>& input, vector <double >& lengths_out, vector<vector<Point>>& static_sample, int image_width, int image_height) {
