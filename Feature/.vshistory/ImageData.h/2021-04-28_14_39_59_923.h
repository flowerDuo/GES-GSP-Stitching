...
vector<vector<Point>> connectCollineationLine(vector<vector<Point>>& contours, vector <double >& lengths_out, map<int, vector<Point>>& static_sample, int image_width, int image_height);
