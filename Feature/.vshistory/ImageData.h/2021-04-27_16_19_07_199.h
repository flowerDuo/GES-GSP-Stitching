...
vector<vector<Point>> connectCollineationLine(vector<vector<Point>> contours, vector<vector<Point>>& contours, vector<double>& lengths);
...
pair<double, double> transRectangular2Polar(Vec4f);
